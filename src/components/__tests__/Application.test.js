...
import { render, cleanup, waitForElement, fireEvent, getByTestId, prettyDOM, getByText, getAllByTestId, queryByText, getByAltText, getByPlaceholderText } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("loads data, books an interview and reduces the spots remaining for Monday by 1", async () => {
    ...
    fireEvent.click(getByAltText(appointment, "https://i.imgur.com/LpaY82x.png"))
